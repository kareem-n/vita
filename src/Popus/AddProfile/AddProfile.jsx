    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      switch (formData.profileType) {
        ...
        case 'patient':
          ...
          break;
        case 'xray_lab':
          axios.post(`https://blissful-gentleness-production.up.railway.app/users/auth/add-xray-laboratory-profile`, {
          ...
          break;
        case 'pharmacy':
          axios.post(`https://blissful-gentleness-production.up.railway.app/users/auth/add-pharmacy-profile`, {
            organizationName: formData.organizationName,
            email: formData.email,
            location: formData.location
          }, {
